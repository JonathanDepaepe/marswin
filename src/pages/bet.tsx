...
// @ts-ignore
export default function Bets({race, raceError, timings, user}) {
                        ...
                        <div className="modal z-50 w-96 p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
                            ...
                            <div
                                ...
                                <form className={"text-black flex flex-col"} onSubmit={submitBet} >
                                    ...
                                    <input type="number" min="1" name={"amount"} className={"bg-white border"} max={parseInt(user.amount as string)}/>
                                    </div>
